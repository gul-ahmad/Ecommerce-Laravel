						...
						<div class="wrap-address-billing">
							...
							<div class="billing-address">
								...
								<p class="row-in-form">
									...
									<input  type="text" name="line1" value="" placeholder="Line Address" wire:model="line1">
									@error('line1')<span class="text-danger">{{$message}}</span>@enderror
								</p>
								<p class="row-in-form">
									<label for="add">Line 2:</label>
									<input  type="text" name="line2" value="" placeholder="Line Address 2" wire:model="line2">
								</p>
								<p class="row-in-form">
								...
								<p class="row-in-form fill-wife">
									...
									<label class="checkbox-field">
										<input name="different-add" id="different-add" value="1" type="checkbox" wire:model="ship_to_different_address">
					...
					<div class="col-md-12">
						<div class="wrap-address-billing">
							...
							<div class="billing-address">
								...
								<p class="row-in-form">
									<label for="add">Line1:</label>
									<input  type="text" name="line1" value="" placeholder="Line Address" wire:model="s_line1">
									@error('s_line1')<span class="text-danger">{{$message}}</span>@enderror
								</p>
								<p class="row-in-form">
									<label for="add">Line 2:</label>
									<input  type="text" name="line2" value="" placeholder="Line Address 2" wire:model="s_line2">
								</p>
								<p class="row-in-form">
									<label for="country">Country<span>*</span></label>
					...
					<div class="summary-item payment-method">
						...
						<div class="choose-payment-methods">
							<label class="payment-method">
								...
								<span class="payment-desc">Oder Now,Pay On Delivery</span>
							</label>
							<label class="payment-method">
