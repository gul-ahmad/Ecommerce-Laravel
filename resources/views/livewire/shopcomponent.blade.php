		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					...
					<div class="wrap-shop-control">
						...
						<div class="wrap-right">
							...
							<div class="sort-item product-per-page">
								<select name="post-per-page" class="use-chosen" wire:model ="pagessize">
					...
					<div class="row">
						...
						<ul class="product-list grid-products equal-container">
							@php
								$wishListItem =Cart::instance('wishlist')->content()->pluck('id');
							@endphp
								...
								<div class="product product-style-3 equal-elem ">
									...
									<div class="product-info">
										...
										<div class="product-wish">
											@if ($wishListItem->contains($product->id))
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
					...
					<div class="widget mercado-widget filter-widget" style="padding-top: 25px">
